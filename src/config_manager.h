...
void ConfigSave(char*); //Сохраняет команды PQR Mod
void ConfigLoad(char*);

void CMD_cfg_save(char*); //Сохраняет команды NFK + PQR Mod
void CMD_cfg_save_pm(char* s); //Сохраняет команды PQR Mod
